      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your user data was updated, reload the page to check the changes!", 4);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your user data was updated successfully!", 2);
            }
...
exports.passwordReplace = void 0;
...
var passwordReplace = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Check your email", 3);
            }
  ...
  return function passwordReplace(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.passwordReplace = passwordReplace;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./updateSettings":"updateSettings.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var logOutBtn = document.querySelector('.header-logout-button');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.updateUserPassword)(passwordCurrent, password, passwordConfirm);
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            email = document.getElementById('forgot-input-email').value;
            (0, _forgotPassword.passwordReplace)(email);
