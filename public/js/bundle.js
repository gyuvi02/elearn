...
var updateUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, email, photo) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.updateUserData)(firstName, lastName, email, photo);
}); // if (userDataForm)
